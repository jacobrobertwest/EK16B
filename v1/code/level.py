                ...
                for col_index, col in enumerate(row):
                    if col != '-1':
                        ...
                        if style == 'grass':
                            ...
                            Tile((x,y),[self.visibile_sprites, self.obstacle_sprites, self.attackable_sprites],'grass',random_grass_image)
                        if style == 'object':
                    ...
                    for target_sprite in collision_sprites:
                        if target_sprite.sprite_type == 'grass':
                            ...
                            for leaf in range(randint(3,6)):
                                self.animation_player.create_grass_particles(pos - offset,[self.visibile_sprites])
                            target_sprite.kill()
                        else:
